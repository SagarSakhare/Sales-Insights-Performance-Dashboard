...
Data subset collected in [SQL dump file](https://github.com/SagarSakhare/Sales-Insights-Performance-Dashboard/blob/main/Database%20dump.sql)and loaded to SQL server for exploring the data tables.
Tables:
1. Customers
2. Date
3. Markets
...
### Data Visualization using [Power BI dashboard](https://github.com/SagarSakhare/Sales-Insights-Performance-Dashboard/blob/main/Sales%20Insights%20-%20Visualization.pbix)
